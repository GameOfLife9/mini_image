...
def model_nn(sess, input_image, model,train_step,J,J_content, J_style,save_path,num_iterations=200):
    ...
    for i in range(num_iterations):
        ...
        if i % 3 == 0:
            ...
            save_image(save_path+"output/" + str(i) + ".png", generated_image)
...
def neual_style_transfer(instance):
    ...
    model_nn(sess, generated_image, model, train_step, J, J_content, J_style,save_path, num_iterations=200)
    #################################################
